...
#' @title Function to create Producer
#' @description Function to create Producer
#' @param metadataBrokerList:String !!Mandatory list of brokers used for bootstrapping knowledge
...
#' @title Function for producer to send message
#' @description Definition of the arguments
...
#' @title function to shut down the producer
#' @description  function to shut down the producer
#' @param producer:producer(Java object)
...
#' @title Function to create consumer
#'
...
#'            --Optional:default:601000 The frequency in ms that the
...
#' @title Reads messages from the topic passed as parameter while creating the consumer object one at a time.Waits for a time
...
#' @title Reads messages from the topic passed as parameter while creating the consumer object in batch.Waits for a time
...
#' @title function to shut down the consumer
rkafka.closeConsumer <- function(ConsumerObj) {
  .jcall(ConsumerObj, "V", "close")
}

#' @title Function to start Simple Consumer
#' @description Creates a KAFKA simple consumer
...
#' @title Function for consumer to read messages from topic
